function FigHan = Plot2DFlattenedStack(Inp,Mold,OptRes_S)
...
if strcmpi(Inp(1).LayerPropagation,'left-to-right')
    fprintf(2,['2D flattened stack plot not implemented for ' ...
        '''left-to-right'' layer propagation. Aborting'])
    FigHan = [];
    return
end
...
for LNo = 1:Inp(1).nLayers
    ...
    for CNo = 1:OptRes_S(LNo).nCourses_trim
        ...
        %PrevXCoor = NewXCoor + MinGap_curr;
