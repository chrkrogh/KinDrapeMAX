function [X,Y,Z,z,F,DT,MoldEdge] = BladeLike___FromMesh_30layer(Inp)
...
elseif Inp(1).MoldLayerNo > 30
    error('Requested layer #%d, but only 30 are available with current mold \nCheck input file',...
        Inp(1).MoldLayerNo)
else
